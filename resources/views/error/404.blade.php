    ...
    <div id="wrapper">
        <svg id="mainImage_create" data-name="mainImage" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 171.2 81.5">
            ...
            <path id="c-1" class="changeColor cls-1"
                ...
                style="fill: rgb(79, 134, 237);"></path>
            <path class="cls-2"
            ...
            <rect id="c-2" class="changeColor cls-7" x="74.82" y="26.48" width="19.14" height="2.45"
                transform="translate(1.29 -3.65) rotate(2.49)" style="fill: rgb(79, 134, 237);"></rect>
            ...
            <text id="title" transform="matrix(1 0 0 1 44.7249 78)">404 Không tìm thấy</text>
        </svg>
    </div>
